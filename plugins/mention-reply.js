    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "US MODS MD 🥀",
            body: config.DESCRIPTION || "POWERED BY USMAN CHACHAR 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "httphttps://i.ibb.co/d0XZLt4K/IMG-20250511-002924-317.jpg", // Static image URL
