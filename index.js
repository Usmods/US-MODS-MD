const {
  ...
  const ownerNumber = ['923161407016']
...
│     *World Best BOT US MODS MD * 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing US MODS MD!* 

╭──〔 🔗 *Information* 〕  
├─ 🧩 *Prefix:* = ${prefix}
├─ 📢 *Join Channel:*  
│   https://whatsapp.com/channel/0029Vb0VL2XBadmVD2Skk53o
├─ 🌟 *Star the Repo:*  
│    https://github.com/Usmods/US MODS MD 
╰─🚀 *Powered by ᴍ ᴜsᴍᴀɴ ᴄʜᴀᴄʜᴀʀ*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/d0XZLt4K/IMG-20250511-002924-317.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ('923204822390', '639853492221', '923161407016');
